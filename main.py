...
def title_bar():
    ...
    title = pyfiglet.figlet_format("INTRUSION DETECTION SYSTEM")
    print(title)
...
# --------------------------------------------------------------------
# calling the recognize from recognize.py file
def recognize_face(input_video):
    recognize.mark_security(input_video)
    main_menu()
